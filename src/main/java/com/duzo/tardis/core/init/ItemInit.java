...
public class ItemInit {
    ...
    // TARDIS Spawn items
    public static final RegistryObject<TARDISSpawnItem> CORAL_TARDIS_ITEM = ITEMS.register("coral_tardis_item", () -> new CoralTARDISSpawnItem(new Item.Properties().tab(CreativeTabInit.TARDIS_TAB).stacksTo(1)));
    public static final RegistryObject<TARDISSpawnItem> WAR_TARDIS_ITEM = ITEMS.register("war_tardis_item", () -> new WarTARDISSpawnItem(new Item.Properties().tab(CreativeTabInit.TARDIS_TAB).stacksTo(1)));
