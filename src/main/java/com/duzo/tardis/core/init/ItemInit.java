...
//    public static final RegistryObject<TARDISSpawnItem> ORIGINAL_TARDIS_ITEM = ITEMS.register("original_tardis_item", () -> new OriginalTARDISSpawnItem(new Item.Properties().tab(CreativeTabInit.TARDIS_TAB).stacksTo(1)));
    ...
    public static final RegistryObject<TARDISSpawnItem> TOYOTA_TARDIS_ITEM = ITEMS.register("toyota_tardis_item", () -> new TARDISSpawnItemBuilder(new Item.Properties().tab(CreativeTabInit.TARDIS_TAB).stacksTo(1)).interior("toyota").exterior("toyota"));
    public static final RegistryObject<TARDISSpawnItem> COPPER_TARDIS_ITEM = ITEMS.register("copper_tardis_item", () -> new TARDISSpawnItemBuilder(new Item.Properties().tab(CreativeTabInit.TARDIS_TAB).stacksTo(1)).interior("copper").exterior("copper"));
