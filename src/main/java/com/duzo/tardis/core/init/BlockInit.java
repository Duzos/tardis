...
import com.duzo.tardis.common.blocks.CoralRampBlock;
...
public class BlockInit {
    ...
    public static final RegistryObject<Block> CORAL_RAMP = BLOCKS.register("coral_ramp", () -> new CoralRampBlock(BlockBehaviour.Properties.of(Material.STONE).noOcclusion().noCollission().strength(3F)));
