...
public class CoralRotorModelSchema extends TARDISControlModelSchema {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TARDISMod.MODID, "coral_rotor"), "main");
	private final ModelPart rotorbottomstrips;
	private final ModelPart rotorbottomstrips2;
	private final ModelPart bb_main;

	public CoralRotorModelSchema(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rotorbottomstrips = partdefinition.addOrReplaceChild("rotorbottomstrips", CubeListBuilder.create(), PartPose.offset(0.0F, 26.0F, 0.0F));

		PartDefinition cube_r1 = rotorbottomstrips.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(46, 129).addBox(-7.25F, -24.0F, -1.25F, 2.5F, 35.0F, 2.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, -6.9F, 0.25F, 0.0F, -2.618F, 0.0F));

		PartDefinition cube_r2 = rotorbottomstrips.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(63, 34).addBox(5.0F, -24.0F, -1.0F, 2.0F, 35.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, -6.9F, -0.25F, 0.0F, -2.618F, 0.0F));

		PartDefinition cube_r3 = rotorbottomstrips.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(46, 129).addBox(4.75F, -24.0F, -1.25F, 2.5F, 35.0F, 2.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, -6.9F, 0.25F, 0.0F, 2.618F, 0.0F));

		PartDefinition cube_r4 = rotorbottomstrips.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(72, 0).addBox(-7.0F, -24.0F, -1.0F, 2.0F, 35.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, -6.9F, -0.25F, 0.0F, 2.618F, 0.0F));

		PartDefinition cube_r5 = rotorbottomstrips.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(61, 72).addBox(5.0F, -24.0F, -1.0F, 2.0F, 35.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.9F, 0.25F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r6 = rotorbottomstrips.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(46, 129).addBox(-7.25F, -24.0F, -1.25F, 2.5F, 35.0F, 2.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.9F, -0.25F, 0.0F, 1.5708F, 0.0F));
		...
		PartDefinition rotorbottomstrips2 = partdefinition.addOrReplaceChild("rotorbottomstrips2", CubeListBuilder.create(), PartPose.offset(0.0F, 22.0F, 0.0F));

		PartDefinition cube_r23 = rotorbottomstrips2.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(0, 36).addBox(-7.0F, -11.0F, -1.0F, 2.0F, 35.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, -41.1F, 0.25F, 0.0F, -2.618F, 0.0F));

		PartDefinition cube_r24 = rotorbottomstrips2.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(46, 129).addBox(4.75F, -11.0F, -1.25F, 2.5F, 35.0F, 2.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, -41.1F, -0.25F, 0.0F, -2.618F, 0.0F));

		PartDefinition cube_r25 = rotorbottomstrips2.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(18, 36).addBox(5.0F, -11.0F, -1.0F, 2.0F, 35.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, -41.1F, 0.25F, 0.0F, 2.618F, 0.0F));

		PartDefinition cube_r26 = rotorbottomstrips2.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(46, 129).addBox(-7.25F, -11.0F, -1.25F, 2.5F, 35.0F, 2.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.25F, -41.1F, -0.25F, 0.0F, 2.618F, 0.0F));

		PartDefinition cube_r27 = rotorbottomstrips2.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(46, 129).addBox(4.75F, -11.0F, -1.25F, 2.5F, 35.0F, 2.5F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -41.1F, 0.25F, 0.0F, 1.5708F, 0.0F));

		PartDefinition cube_r28 = rotorbottomstrips2.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(45, 36).addBox(-7.0F, -11.0F, -1.0F, 2.0F, 35.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -41.1F, -0.25F, 0.0F, 1.5708F, 0.0F));
