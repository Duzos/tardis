...
public class WarRotorModelSchema extends TARDISControlModelSchema {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TARDISMod.MODID, "war_rotor"), "main");
	private final ModelPart rotorbottomstrips;
	private final ModelPart bb_main;

	public WarRotorModelSchema(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rotorbottomstrips = partdefinition.addOrReplaceChild("rotorbottomstrips", CubeListBuilder.create(), PartPose.offset(0.0F, 28.0F, 0.0F));
