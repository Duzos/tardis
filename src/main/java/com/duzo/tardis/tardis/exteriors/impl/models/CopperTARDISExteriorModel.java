...
public class CopperTARDISExteriorModel extends TARDISExteriorModelSchema {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TARDISMod.MODID, "copper_exterior"), "main");
    private final ModelPart bone;

    public CopperTARDISExteriorModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-26.5F, -1.0F, -26.5F, 53.0F, 3.0F, 53.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(0, 37).addBox(-3.0F, -101.525F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(30, 63).addBox(-2.0F, -102.525F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(34, 57).addBox(-2.0F, -95.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(34, 22).addBox(-2.0F, -101.025F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(16, 0).addBox(-0.5F, -103.025F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(14, 65).addBox(-1.5F, -99.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(66, 73).addBox(-1.75F, -99.5F, -1.75F, 3.5F, 4.0F, 3.5F, new CubeDeformation(0.0F))
        ...
        PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(279, 368).addBox(-21.0F, -35.0F, -26.0F, 42.0F, 6.0F, 52.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -48.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

        PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(33, 29).addBox(0.0F, -83.0F, -4.0F, 0.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -17.5F, 0.0F, 0.0F, -0.7854F, 0.0F));
