...
public class WarTARDISExteriorModel extends TARDISExteriorModelSchema {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(TARDISMod.MODID, "war_exterior"), "main");
	private final ModelPart bone;

	public WarTARDISExteriorModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 37).addBox(-3.0F, -100.275F, -3.0F, 6.0F, 0.8F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(30, 63).addBox(-2.0F, -101.275F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(34, 57).addBox(-2.0F, -95.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(13, 96).addBox(-1.9F, -98.85F, -1.9F, 3.75F, 3.0F, 3.75F, new CubeDeformation(0.0F))
		.texOffs(20, 79).addBox(-1.5F, -99.75F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(20, 79).addBox(-1.5F, -95.85F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(33, 29).addBox(0.0F, -83.0F, -4.0F, 0.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -17.2F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r4 = bone.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(17, 37).addBox(0.0F, -83.0F, -4.0F, 0.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -17.2F, 0.0F, 0.0F, 0.7854F, 0.0F));
